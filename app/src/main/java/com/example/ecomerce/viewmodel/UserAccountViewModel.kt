...
import com.example.ecomerce.EcomerceApplication
import com.example.ecomerce.data.User
import com.example.ecomerce.util.RegisterValidation
import com.example.ecomerce.util.Resource
import com.example.ecomerce.util.validateEmail
        ...
        viewModelScope.launch {
            try {
                val imageBitmap = MediaStore.Images.Media.getBitmap(
                    getApplication<EcomerceApplication>().contentResolver,
                    imageUri
                )
