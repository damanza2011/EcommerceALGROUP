...
public abstract class Hilt_FiltroAceiteFragment extends BaseCategoryFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FiltroAceiteFragment_GeneratedInjector) this.generatedComponent()).injectFiltroAceiteFragment(UnsafeCasts.<FiltroAceiteFragment>unsafeCast(this));
    }
  }
