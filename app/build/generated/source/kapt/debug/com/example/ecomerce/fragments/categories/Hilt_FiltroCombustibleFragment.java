...
public abstract class Hilt_FiltroCombustibleFragment extends BaseCategoryFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FiltroCombustibleFragment_GeneratedInjector) this.generatedComponent()).injectFiltroCombustibleFragment(UnsafeCasts.<FiltroCombustibleFragment>unsafeCast(this));
    }
  }
