...
public abstract class Hilt_FiltroAireFragment extends BaseCategoryFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FiltroAireFragment_GeneratedInjector) this.generatedComponent()).injectFiltroAireFragment(UnsafeCasts.<FiltroAireFragment>unsafeCast(this));
    }
  }
