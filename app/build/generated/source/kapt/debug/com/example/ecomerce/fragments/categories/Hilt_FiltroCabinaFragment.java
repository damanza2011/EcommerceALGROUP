...
public abstract class Hilt_FiltroCabinaFragment extends BaseCategoryFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FiltroCabinaFragment_GeneratedInjector) this.generatedComponent()).injectFiltroCabinaFragment(UnsafeCasts.<FiltroCabinaFragment>unsafeCast(this));
    }
  }
